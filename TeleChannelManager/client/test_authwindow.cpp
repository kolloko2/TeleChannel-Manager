...
private slots:
    ...
    void testLoginEmptyFields() {
        ...
        QCOMPARE(loginStatus->text(), QString("Please fill in all fields."));
    }
    ...
    void testRegisterMismatchingPasswords() {
        ...
        QCOMPARE(registerStatus->text(), QString("Passwords do not match!"));
    }
    ...
    void testRegisterShortPassword() {
        ...
        QCOMPARE(registerStatus->text(), QString("Password must be at least 6 characters!"));
    }
